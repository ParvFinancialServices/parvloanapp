...
const PersonalDetails = ({ formData, setFormData, errors }) => { // Added errors prop
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* Changed sm:grid-cols-2 to md:grid-cols-2 for consistency */}
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="purpose_of_loan" className={cn("w-full", errors.purpose_of_loan && "border-red-500 focus-visible:ring-red-500")}>
            ...
            {errors.purpose_of_loan && <p className="text-red-500 text-xs mt-1">{errors.purpose_of_loan}</p>}
          </div>
        </div>
      </div>
            ...
            <Checkbox
              ...
              onCheckedChange={(checked) => {
                ...
                if (checked) {
                    ...
                    setErrors(prevErrors => { // Assuming setErrors is available via context or prop from parent
                        ...
                        presentAddressFields.forEach(field => delete newErrors[field]);
                        return newErrors;
                    });
                }
              }}
