...
const LoanEnquiryForm = () => {
    return (
        <div>
            <div className="max-w-7xl mx-auto bg-white my-6 font-[sans-serif]">
                ...
                <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                    ...
                    <div className="bg-blue-700 rounded-lg p-6 h-full max-lg:order-1">
                        ...
                        <ul className="mt-6 space-y-6">
                            ...
                            <li className="flex items-center">
                                ...
                                <a href="javascript:void(0)" className="text-xs text-gray-300 ml-3 w-[90%]">
                                    REGD. OFFICE-HOTEL NEW MAYUR, DUMRAO ROAD, BIKRAMGANJ, ROHTAS BIHAR 802212.
                                </a>
                            </li>
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff' viewBox="0 0 368.16 368.16">
                        ...
                        <ul className="flex flex-wrap gap-4 mt-6">
                            <li className="bg-blue-800 hover:bg-blue-900  h-10 w-10 rounded-full flex items-center justify-center shrink-0">
