import { Clock, LocateIcon, MapIcon, MapPin, Phone } from "lucide-react";
                    ...
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-1/3">
                            <Link href="/" className="flex items-center space-x-1 rtl:space-x-reverse">
                                ...
                                <div className="flex flex-col justify-start">
                                    <span className=" text-2xl text-slate-100 font-semibold whitespace-nowrap leading-5 dark:text-white">PARV</span>
                                    <span className="text-[0.6rem] text-blue-600">Financial Services</span>
                                </div>
                            </Link>
                            <p className="text-justify mt-4">
                                {/* Our goal at Parv Financial Services is to provide access to Personal Loans, Vehicle Loan, Home Loan, Business Loan at insight competitive interest rates . We are the financial service provider, you can use our Financial product. */}
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul className="leading-8">
                                ...
                                <li><a href="#" className="hover:text-blue-400">Calculator</a></li>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul className="leading-8">
                                ...
                                <li><a href="#" className="hover:text-blue-400">Vehicle Loan</a></li>
                                <li><a href="#" className="hover:text-blue-400">Gold Loan</a></li>
                            </ul>
                        </div>
