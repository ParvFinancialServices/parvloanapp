...
export default function BusinessLoanPage() {
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto w-full bg-gray-50">
            {/* <Header /> */}
            <div>
                <AboutBusinessLoan item={BusinessLoanData} />
                <Features data={BusinessLoanData?.features} />
                <Eligibility items={BusinessLoanData?.eligibility} />
                <LoanTypes items={BusinessLoanData?.loanTypes} />
                <AdditionalDetails items={BusinessLoanData?.additionalBenefits} />
                <DocumentsRequired items={BusinessLoanData?.documents} />
            </div>
        </div>
    );
}
