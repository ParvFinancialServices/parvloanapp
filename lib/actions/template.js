...
export const getPendingApprovalTemplate = (username, password) => {
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Account Created - Awaiting Approval</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<div class="container">
    <div class="content">
        <h3>Your Parv Financials Account Has Been Created</h3>
        <p>Thank you for registering with Parv Financials. Your account has been created and is currently pending approval from the admin.</p>
        <div class="details">
            <p><strong>Username:</strong> ${username}</p>
            <p><strong>Password:</strong> ${password} (Please keep this secure)</p>
        </div>
        <p>Once your account is approved, you will receive a confirmation email and will be able to access your dashboard.</p>
    </div>
    <div class="footer">
        <p>&copy; 2025 Parv Financials. All rights reserved.</p>
    </div>
